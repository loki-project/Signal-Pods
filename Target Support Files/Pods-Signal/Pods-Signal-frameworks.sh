...
if [[ "$CONFIGURATION" == "App Store Release" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SessionAxolotlKit/SessionAxolotlKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SessionHKDFKit/SessionHKDFKit.framework"
